...
@st.cache_data
def load_data():
    # Lê o arquivo Pasta1.xlsx da mesma pasta do projeto
...
if not dados_carregados:
    st.error(f"Erro ao carregar o arquivo Pasta1.xlsx: {erro}")
    st.info("Certifique-se de que o arquivo 'Pasta1.xlsx' está na mesma pasta do dashboard.")
    st.stop()
